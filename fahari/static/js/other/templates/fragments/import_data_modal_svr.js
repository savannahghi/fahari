document.addEventListener("DOMContentLoaded", function() {
    ...
    $btn_ingest_data.click(function(event) {
        ...
        var selected_county = $("#id_adapter").val();
        var ingest_url = "/api/stock_receipts_adapters/" + selected_county + "/ingest_from_last_position/";
        $.ajax({
            beforeSend: function() {
            ...
            error: function(request, status, error_thrown) {
                ...
                handleErrorMessage(data.row_index, data.error_messages);
            },
            headers: {
            ...
            success: function(data, status) {
                handleSuccessMessage(data.ingested_rows);
            },
            url: ingest_url,
        });
    });
