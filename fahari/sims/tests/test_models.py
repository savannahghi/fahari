...
class QuestionGroupTest(_CommonTestCase):
    ...
    def test_manager_annotate_with_stats_method(self) -> None:
        ...
        assert not question_group1.stats_is_parent
        assert not question_group3.stats_is_parent
        assert not question_group4.stats_is_parent
        assert question_group2.stats_is_parent

        assert question_group1.stats_is_answerable
        assert question_group2.stats_is_answerable
        assert not question_group3.stats_is_answerable
        assert not question_group4.stats_is_answerable

        assert not question_group1.stats_is_complete_for_responses
        assert question_group2.stats_is_complete_for_responses
        assert question_group3.stats_is_complete_for_responses
        assert question_group4.stats_is_complete_for_responses

        assert not question_group1.stats_is_not_applicable_for_responses
        assert not question_group3.stats_is_not_applicable_for_responses
        assert not question_group4.stats_is_not_applicable_for_responses
        assert question_group2.stats_is_not_applicable_for_responses
