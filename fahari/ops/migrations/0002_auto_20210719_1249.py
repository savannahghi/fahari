    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "activity",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="ops.activity"
                    ),
                ),
                (
                    "organisation",
                    models.ForeignKey(
                        ...
                        related_name="ops_weeklyprogramupdate_related",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ops_sitementorship_related",
                        to="common.organisation",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ops_operationalarea_related",
                        to="common.organisation",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ops_dailyupdate_related",
                        to="common.organisation",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "planned_date",
                    models.DateField(help_text="Planned date for the activity"),
                ),
                ("requested_date", models.DateField(help_text="Date requested")),
                (
                    "procurement_date",
                    models.DateField(help_text="Date received by procurement"),
                ),
                (
                    "finance_approval_date",
                    models.DateField(help_text="Date received by Finance for approvals"),
                ),
                (
                    "final_approval_date",
                    models.DateField(help_text="Date approved by COP/DCOP/FAD"),
                ),
                (
                    "done_date",
                    models.DateField(help_text="Date when activity/procurement done"),
                ),
                (
                    "invoiced_date",
                    models.DateField(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ops_activitylog_related",
                        to="common.organisation",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="ops.operationalarea"
            ),
        ),
        migrations.AddField(
            model_name="activity",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name="ops_activity_related",
                to="common.organisation",
            ),
        ),
        migrations.AddField(
