...
from .views import (
    ...
    GoupSectionCreateView,
    GoupSectionDeleteView,
    GoupSectionListView,
    GoupSectionUpdateView,
    QuestionCreateView,
    QuestionDeleteView,
...
urlpatterns = [
    ...
    path(
        "group_sections",
        view=GoupSectionListView.as_view(),
        name="group_sections",
    ),
    path(
        "group_section_create",
        view=GoupSectionCreateView.as_view(),
        name="group_section_create",
    ),
    path(
        "group_section_update/<pk>",
        view=GoupSectionUpdateView.as_view(),
        name="group_section_update",
    ),
    path(
        "group_section_delete/<pk>",
        view=GoupSectionDeleteView.as_view(),
