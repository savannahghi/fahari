...
from .views import (
    ...
    GroupSectionCreateView,
    GroupSectionDeleteView,
    GroupSectionListView,
    GroupSectionUpdateView,
    MentorshipTeamListView,
    QuestionCreateView,
    QuestionDeleteView,
...
urlpatterns = [
    ...
    path(
        "group_sections",
        view=GroupSectionListView.as_view(),
        name="group_sections",
    ),
    path(
        "group_section_create",
        view=GroupSectionCreateView.as_view(),
        name="group_section_create",
    ),
    path(
        "group_section_update/<pk>",
        view=GroupSectionUpdateView.as_view(),
        name="group_section_update",
    ),
    path(
        "group_section_delete/<pk>",
        view=GroupSectionDeleteView.as_view(),
        name="group_section_delete",
    ),
    path(
    ...
    path(
        "mentorship_teams",
        view=MentorshipTeamListView.as_view(),
        name="mentorship_teams",
    ),
]
