...
import pepfar_mle.common.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.CharField(choices=[('47_NAIROBI_CITY', 'Nairobi City'), ('46_NYAMIRA', 'Nyamira'), ('45_KISII', 'Kisii'), ('44_MIGORI', 'Migori'), ('43_HOMA_BAY', 'Homa Bay'), ('42_KISUMU', 'Kisumu'), ('41_SIAYA', 'Siaya'), ('40_BUSIA', 'Busia'), ('39_BUNGOMA', 'Bungoma'), ('38_VIHIGA', 'Vihiga'), ('37_KAKAMEGA', 'Kakamega'), ('36_BOMET', 'Bomet'), ('35_KERICHO', 'Kericho'), ('34_KAJIADO', 'Kajiado'), ('33_NAROK', 'Narok'), ('32_NAKURU', 'Nakuru'), ('31_LAIKIPIA', 'Laikipia'), ('30_BARINGO', 'Baringo'), ('29_NANDI', 'Nandi'), ('28_ELGEYO_MARAKWET', 'Elgeyo/Marakwet'), ('27_UASIN_GISHU', 'Uasin Gishu'), ('26_TRANS_NZOIA', 'Trans Nzoia'), ('25_SAMBURU', 'Samburu'), ('24_WEST_POKOT', 'West Pokot'), ('23_TURKANA', 'Turkana'), ('22_KIAMBU', 'Kiambu'), ('21_MURANGA', "Murang'a"), ('20_KIRINYAGA', 'Kirinyaga'), ('19_NYERI', 'Nyeri'), ('18_NYANDARUA', 'Nyandarua'), ('17_MAKUENI', 'Makueni'), ('16_MACHAKOS', 'Machakos'), ('15_KITUI', 'Kitui'), ('14_EMBU', 'Embu'), ('13_THARAKA_NITHI', 'Tharaka-Nithi'), ('12_MERU', 'Meru'), ('11_ISIOLO', 'Isiolo'), ('10_MARSABIT', 'Marsabit'), ('09_MANDERA', 'Mandera'), ('08_WAJIR', 'Wajir'), ('07_GARISSA', 'Garissa'), ('06_TAITA_TAVETA', 'Taita/Taveta'), ('05_LAMU', 'Lamu'), ('04_TANA_RIVER', 'Tana River'), ('03_KILIFI', 'Kilifi'), ('02_KWALE', 'Kwale'), ('01_MOMBASA', 'Mombasa')], max_length=24)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_by', models.UUIDField(blank=True, null=True)),
                ('content_type', models.CharField(choices=[('image/png', 'PNG'), ('image/jpeg', 'JPEG'), ('application/pdf', 'PDF'), ('application/vnd.ms-excel', 'xlsx'), ('application/msword', 'doc'), ('application/vnd.openxmlformats-officedocument.wordprocessingml.document.docx', 'docx'), ('application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'xlsx')], max_length=100)),
                ('data', models.FileField(max_length=65535, upload_to=pepfar_mle.common.models.get_directory)),
                ...
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='common_facilityattachment_related', to='common.organisation')),
            ],
            options={
                'ordering': ('-updated', '-created'),
            },
