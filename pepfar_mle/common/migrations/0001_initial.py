# Generated by Django 3.1.12 on 2021-07-01 10:17

import pepfar_mle.common.models
from django.db import migrations, models
import django.db.models.deletion
import django.utils.timezone
import pepfar_mle.transitions.mixins
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(pepfar_mle.transitions.mixins.TransitionAndLogMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organisation_logs', to='common.organisation')),
            ],
            options={
                'ordering': ('-updated', '-created'),
                'abstract': False,
            },
            bases=(pepfar_mle.common.models.GetUserFullname, models.Model),
        ),
        migrations.CreateModel(
            name='Facility',
            fields=[
                ...
                ('organisation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='common_facility_related', to='common.organisation')),
            ],
            options={
                'ordering': ('-updated', '-created'),
                'abstract': False,
            },
            bases=(pepfar_mle.common.models.ValidationErrorsMixin, models.Model),
        ),
    ]
